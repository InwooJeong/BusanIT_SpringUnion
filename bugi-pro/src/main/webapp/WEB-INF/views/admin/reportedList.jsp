    ...
    <div class="container mt-2">
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          <h3>신고 당한 회원 전체 목록</h3>
          <h5>신고 당한 회원 수 : ${pageMaker.totalCount }</h5>
          ...
          <table class="table-hover" id="mList" border="1">
          	...
          	<tbody>
          		<c:forEach var="member" items="${reportedList }">
          			<tr>
		  ...
		  <nav aria-label="Page navigation example">
          	<ul class="pagination justify-content-center my-4">
          		...
          		<li class="page-item ${(pageMaker.prev)?'':'disable'}">
					<a class="page-link" href="${(pageMaker.prev)?'/admin/reportedList?pageNum='+=(pageMaker.startPage-1):''}">&lt;</a>
				</li>
          		
          		<c:forEach var="i" begin="${pageMaker.startPage }" end="${pageMaker.endPage }" step="1">
          			<li class="page-item ${(pageMaker.cri.pageNum eq i)?'active':'' }">
          				<a class="page-link" href="/admin/reportedList?pageNum=${i }">[${i }]</a>
          			</li>
          		</c:forEach>
          		
          		<li class="page-item ${(pageMaker.next)?'':'disable'}">
					<a class="page-link" href="${(pageMaker.next)?'/admin/reportedList?pageNum='+=(pageMaker.endPage+1):''}">&gt;</a>
				</li>
